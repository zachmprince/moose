...
x_pp = 'h'
y_pp = ['error_real', 'error_imag','error_n']
...
for i in range(0, runs):
    ...
    # Read the file
    root = pyhit.load('microwave_heating.i')
    ...
    pyhit.write("microwave_heating.i", root)

    input_files = ['microwave_heating.i']
...
fig.plot(data, label=['E_Real', 'E_Imag.','Heated Species'], marker='o', markersize=8)
fig.save('microwave_heating_convergence.png')
data.to_csv('microwave_heating_convergence.csv')
