#!/usr/bin/env python3
# Script to run spatial convergence study on vector_ADmaterial_wave_reaction.i
...
for i in range(0, runs):
    ...
    # Read the file
    root = pyhit.load('vector_ADmaterial_wave_reaction.i')
    ...
    pyhit.write("vector_ADmaterial_wave_reaction.i", root)

    input_files = ['vector_ADmaterial_wave_reaction.i']
...
fig.save('vector_ADmaterial_wave_reaction_convergence.png')
data.to_csv('vector_ADmaterial_wave_reaction_convergence.csv')
