...
class TestAlertBrands(MooseDocsTestCase):
    ...
    def testMaterialize(self):
        for i, b in enumerate(self.BRANDS):
            res = self.render(
                self.tokenize(self.TEXT[i]), renderer=base.MaterializeRenderer()
            )
            ...
            title = res(0)(0)
            self.assertHTMLTag(
                title, "div", size=2, class_="card-title moose-alert-title"
            )
            self.assertHTMLTag(
                title(0),
                "i",
            ...
            self.assertHTMLTag(
                title(1), "span", size=1, class_="moose-alert-title-brand", string=b
            )
    ...
    def testLatex(self):
        for i, b in enumerate(self.BRANDS):
            res = self.render(
                self.tokenize(self.TEXT[i]), renderer=base.LatexRenderer()
            )
...
class TestAlertConstruction(MooseDocsTestCase):
    ...
    def testHTML(self):
        ...
        self.assertHTMLTag(
            res(0), "div", size=2, class_="moose-alert moose-alert-construction"
        )
        self.assertHTMLTag(res(0, 0), "div", size=2, class_="moose-alert-title")
    ...
    def testMaterialize(self):
        ...
        self.assertHTMLTag(res, "div", size=1, class_="moose-content")
        self.assertHTMLTag(
            res(0), "div", size=2, class_="card moose-alert moose-alert-construction"
        )
...
class TestAlertTitle(MooseDocsTestCase):
    ...
    def testMaterialize(self):
        ...
        self.assertHTMLTag(res, "div", size=1, class_="moose-content")
        self.assertHTMLTag(
            res(0), "div", size=2, class_="card moose-alert moose-alert-note"
        )
...
class TestAlertTitleLink(MooseDocsTestCase):
    ...
    def testHTML(self):
        ...
        self.assertHTMLTag(
            res(0, 0, 2), "a", size=1, href="https://google.com", string="Google"
        )
    ...
    def testMaterialize(self):
        ...
        self.assertHTMLTag(res, "div", size=1, class_="moose-content")
        self.assertHTMLTag(
            res(0), "div", size=2, class_="card moose-alert moose-alert-tip"
        )
        ...
        self.assertHTMLString(title(1)(1), content=":")
        self.assertHTMLTag(
            title(2), "a", size=1, href="https://google.com", string="Google"
        )
...
class TestAlertWithCode(MooseDocsTestCase):
    ...
    def testHTML(self):
        ...
        self.assertHTMLTag(res, "body", size=1)
        self.assertHTMLTag(
            res(0), "div", size=2, class_="moose-alert moose-alert-error"
        )
        self.assertHTMLTag(res(0, 0), "div", size=2, class_="moose-alert-title")
    ...
    def testMaterialize(self):
        ...
        self.assertHTMLTag(res, "div", size=1, class_="moose-content")
        self.assertHTMLTag(
            res(0), "div", size=2, class_="card moose-alert moose-alert-error"
        )

        self.assertHTMLTag(
            res(0, 0), "div", size=2, class_="card-title moose-alert-title"
        )
        self.assertHTMLTag(
            res(0, 0, 0),
            "i",
