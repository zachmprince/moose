...
class TestImage(MooseDocsTestCase):
    ...
    def testAST(self):
        ...
        self.assertSize(ast, 1)
        self.assertToken(
            ast(0), "Image", src="Flag_of_Idaho.svg", tex="Flag_of_Idaho.pdf"
        )
        ...
        self.assertToken(
            ast(0, 0), "FloatCaption", key="idaho", prefix="Figure", number=1
        )
        ...
        # in float
        ast = self.tokenize(
            "!media Flag_of_Idaho.svg caption=test id=idaho prefix=Flag"
        )
        self.assertSize(ast, 2)
        self.assertToken(ast(0), "Float", bottom=True, command="figure")
        self.assertToken(
            ast(0, 0), "FloatCaption", key="idaho", prefix="Flag", number=1
        )
        self.assertToken(ast(0, 0, 0), "Word", content="test")
        self.assertToken(ast(0, 1), "Image", src="Flag_of_Idaho.svg")
        self.assertToken(ast(1), "Shortcut", key="idaho", link="#idaho")
    ...
    def testHTML(self):
        ...
        self.assertHTMLTag(
            res(0, 1, 1), "span", size=1, class_="moose-caption-text", string="test"
        )
    ...
    def testMaterialize(self):
        ...
        self.assertHTMLTag(
            res(0, 0, 0, 0), "img", size=0, src="testing/Flag_of_Idaho.svg"
        )
        ...
        self.assertHTMLTag(
            res(0, 0, 1, 1), "span", size=1, class_="moose-caption-text", string="test"
        )
...
class TestVideo(MooseDocsTestCase):
    ...
    def testAST(self):
        ...
        self.assertToken(ast(0, 0, 0), "Word", content="test")
        self.assertToken(
            ast(0, 1), "Video", src="http://clips.vorwaerts-gmbh.de/VfE.webm"
        )
        self.assertToken(ast(1), "Shortcut", key="idaho", link="#idaho")
        self.assertToken(ast(1, 0), "String", content="Figure 1")
        ...
        # in float
        ast = self.tokenize(
            "!media http://clips.vorwaerts-gmbh.de/VfE.webm caption=test id=idaho prefix=Flag"
        )
        self.assertSize(ast, 2)
        self.assertToken(ast(0), "Float", bottom=True, command="figure")
        self.assertToken(
    ...
    def testHTML(self):
        ...
        self.assertHTMLTag(
            res(0, 0, 0), "source", src="http://clips.vorwaerts-gmbh.de/VfE.webm"
        )
        ...
        self.assertHTMLTag(
            res(0, 0, 0, 0), "source", src="http://clips.vorwaerts-gmbh.de/VfE.webm"
        )
        self.assertHTMLTag(res(0, 1), "p", size=2, class_="moose-caption")
        self.assertHTMLTag(
            res(0, 1, 0),
    ...
    def testMaterialize(self):
        ...
        self.assertHTMLTag(res, "div", size=1, class_="moose-content")
        self.assertHTMLTag(
            res(0), "div", size=1, class_="card moose-float", id_="idaho"
        )
        ...
        self.assertHTMLTag(
            res(0, 0, 0, 0, 0), "source", src="http://clips.vorwaerts-gmbh.de/VfE.webm"
        )
        self.assertHTMLTag(res(0, 0, 1), "p", size=2, class_="moose-caption")
        self.assertHTMLTag(
            res(0, 0, 1, 0),
...
class TestYouTube(MooseDocsTestCase):
    ...
    def testAST(self):
        ...
        self.assertSize(ast, 1)
        self.assertToken(
            ast(0), "Video", src="https://www.youtube.com/not_real", youtube=True
        )
...
class TestFloatReference(MooseDocsTestCase):
    ...
    def testLocalReference(self):
        ...
        self.assertToken(
            ast(0, 0), "FloatReference", size=0, label="dummy", filename=None
        )
    ...
    def testNonLocalReference(self):
        ...
        self.assertToken(ast(0), "Paragraph", size=1)
        self.assertToken(
            ast(0, 0), "FloatReference", size=0, label="dummy", filename="foo_bar.md"
        )
