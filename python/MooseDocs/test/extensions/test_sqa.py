...
class TestSQARequirementsAST(MooseDocsTestCase):
    ...
    def testASTPrereqLink(self):
        ...
        self.assertToken(
            ast(1)(3)(1), "SQARequirementPrerequisites", size=0, specs=[("r1", "1.2.2")]
        )
        self.assertToken(
            ast(1)(4)(1), "SQARequirementPrerequisites", size=0, specs=[("r1", "1.2.2")]
        )
    ...
    def testASTCollectionsLink(self):
        ...
        self.assertToken(
            ast(0)(6)(2), "SQARequirementCollections", size=0, collections={"Andrew"}
        )
    ...
    def testASTTypesLink(self):
        ...
        self.assertToken(
            ast(1)(3)(1), "SQARequirementTypes", size=0, types={"TestType"}
        )
    ...
    def _assertAST_tree(self, ast):
        ...
        self.assertToken(
            ast(0), "SQARequirementMatrixHeading", category="Demo", string="Tree"
        )
    ...
    def _assertAST_common(self, ast):
        ...
        self.assertToken(
            ast(0), "SQARequirementMatrixHeading", category="Demo", string="Common"
        )
    ...
    def setupExtension(self, ext):
        if ext == sqa:
            return dict(
                ...
                categories=dict(
                    Demo=dict(directories=["python/MooseDocs/test"], specs=["demo"]),
                    Empty=dict(directories=["python/MooseDocs/test"], specs=["demo2"]),
                ),
            )
...
class TestSQARequirementsCrossReference(MooseDocsTestCase):
    ...
    @mock.patch.object(
        base.Translator,
        "findPage",
        side_effect=lambda x: TestSQARequirementsCrossReference.NodeProxy(local=x),
    )
    def testCommand(self, mock_find_page):
        ...
        self.assertToken(
            ast(0)(0), "SQARequirementMatrixHeading", category="Demo", size=1
        )
        ...
        self.assertToken(
            ast(0)(1)(2), "SQARequirementDesign", size=0, design=["core.md"]
        )
    ...
    def setupExtension(self, ext):
        if ext == sqa:
            return dict(
                ...
                categories=dict(
                    Demo=dict(directories=["python/MooseDocs/test"], specs=["demo"]),
                    Demo2=dict(directories=["python/MooseDocs/test"], specs=["demo"]),
                ),
            )
...
class TestSQARequirementsRender(MooseDocsTestCase):
    ...
    def testCompleteRender(self):
        ...
        self.assertHTMLTag(
            res(0)(0)(0), "span", string="1.1.1", class_="moose-sqa-requirement-number"
        )
        self.assertHTMLTag(
            res(0)(0)(1), "span", size=3, class_="moose-sqa-requirement-content"
        )
        ...
        self.assertHTMLTag(
            res(0)(5)(0), "span", string="1.1.6", class_="moose-sqa-requirement-number"
        )
        self.assertHTMLTag(
            res(0)(5)(1), "span", size=6, class_="moose-sqa-requirement-content"
        )
    ...
    def testSQARequirementMatrix(self):
        ...
        self.assertSize(res, 1)
        self.assertHTMLTag(
            res(0), "ul", size=0, class_="moose-sqa-requirements collection with-header"
        )
    ...
    def testSQARequirementMatrixItemSatisfied(self):
        ...
        self.assertHTMLTag(
            res(0)(0), "span", string="F1.1.1", class_="moose-sqa-requirement-number"
        )
        self.assertHTMLTag(
            res(0)(1), "span", size=0, class_="moose-sqa-requirement-content"
        )
        ...
        self.assertHTMLTag(
            ...
            string="F1.1.1",
            id_="path:Foo",
            class_="moose-sqa-requirement-number tooltipped",
            **{"data-tooltip": "path:Foo"},
        )
        self.assertHTMLTag(
            res(0)(1), "span", size=0, class_="moose-sqa-requirement-content"
        )
    ...
    def testSQARequirementMatrixItemUnSatisfied(self):
        ...
        self.assertHTMLTag(
            ...
            "span",
            string="1.1.1",
            class_="moose-sqa-requirement-number moose-sqa-requirement-unsatisfied",
        )
        ...
        self.assertHTMLTag(
            ...
            "span",
            string="1.1.1",
            class_="moose-sqa-requirement-number tooltipped moose-sqa-requirement-unsatisfied",
        )
    ...
    def testSQARequirementDesign(self, mock_design):
        ...
        tok = sqa.SQARequirementDesign(
            None, design=["file.md"], line=42, filename="file"
        )
    ...
    def testSQARequirementIssues(self):
        ...
        tok = sqa.SQARequirementIssues(
            None, issues=["#1", "#2"], url="https://github.com/idaholab/moose"
        )
        res = self.render(tok, renderer=base.HTMLRenderer())
        self.assertHTMLTag(res, "body", size=1)
        ...
        self.assertHTMLTag(
            ...
            "a",
            string="#1",
            href="https://github.com/idaholab/moose/issues/1",
        )
        self.assertHTMLTag(
            res(0)(2),
            "a",
            string="#2",
            href="https://github.com/idaholab/moose/issues/2",
        )
        ...
        self.assertLatexArg(
            res(1), 0, "Brace", "https://github.com/idaholab/moose/issues/1"
        )
