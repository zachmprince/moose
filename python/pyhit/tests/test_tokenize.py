...
"""Tests hit token creation with pyhit."""
...
class TestHitTokenize(unittest.TestCase):
    ...
    def testToken(self):
        ...
        self.assertNotEqual(
            tok, pyhit.Token(pyhit.TokenType.LEFTBRACKET, b"[", b"", 10, 1980)
        )
    ...
    def testTokenize(self):
        ...
        self.assertEqual(
            tokens[2],
            pyhit.Token(
                pyhit.TokenType.RIGHTBRACKET, b"]", b"simple_diffusion.i", 8, 1
            ),
        )
        self.assertEqual(
            tokens[3],
            pyhit.Token(
                pyhit.TokenType.LEFTBRACKET, b"[", b"simple_diffusion.i", 12, 2
            ),
        )
        self.assertEqual(
            tokens[4],
        ...
        self.assertEqual(
            tokens[5],
            pyhit.Token(
                pyhit.TokenType.RIGHTBRACKET, b"]", b"simple_diffusion.i", 17, 2
            ),
        )
        self.assertEqual(
            tokens[6],
        ...
        self.assertEqual(
            tokens[8],
            pyhit.Token(
                pyhit.TokenType.STRING, b"Diffusion", b"simple_diffusion.i", 30, 3
            ),
        )
        self.assertEqual(
            tokens[9],
            pyhit.Token(
                pyhit.TokenType.INLINECOMMENT, b"# DOOSE!", b"simple_diffusion.i", 40, 3
            ),
        )
        self.assertEqual(
            tokens[10],
            pyhit.Token(
                pyhit.TokenType.LEFTBRACKET, b"[", b"simple_diffusion.i", 51, 4
            ),
        )
        self.assertEqual(
            tokens[11],
        ...
        self.assertEqual(
            tokens[12],
            pyhit.Token(
                pyhit.TokenType.RIGHTBRACKET, b"]", b"simple_diffusion.i", 52, 4
            ),
        )
        self.assertEqual(
            tokens[13],
            pyhit.Token(
                pyhit.TokenType.LEFTBRACKET, b"[", b"simple_diffusion.i", 54, 5
            ),
        )
        self.assertEqual(
            tokens[14],
        ...
        self.assertEqual(
            tokens[15],
            pyhit.Token(
                pyhit.TokenType.RIGHTBRACKET, b"]", b"simple_diffusion.i", 55, 5
            ),
        )
        self.assertEqual(
            tokens[16],
