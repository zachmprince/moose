...
class TestSearch(unittest.TestCase):
    ...
    def testFindAll(self):
        """Test moosepy.tree.search.findall."""
        root = build_tree()
        nodes = list(
            moosetree.findall(
                root,
        ...
        nodes = list(
            moosetree.search.findall(
                root, lambda n: "year" in n, method=moosetree.IterMethod.PRE_ORDER
            )
        )
    ...
    def testFindAttr(self):
        """Test moosepy.tree.search.findall with attribute specification."""
        root = build_tree()
